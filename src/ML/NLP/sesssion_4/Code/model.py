...
class ResidualConnection(nn.Module):
    """
    A module that applies a residual connection to the input tensor.

    Args:
        features (int): The number of features in the input tensor.
        dropout (float): The dropout probability for the dropout layer.
    ...
    def forward(self, x, sublayer):
        ...
        Args:
            ...
            sublayer (callable): The sublayer to apply the residual connection to.
